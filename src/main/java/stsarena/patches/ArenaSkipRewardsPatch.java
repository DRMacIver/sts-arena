...
public class ArenaSkipRewardsPatch {
     ...
     */
    @SpirePatch(cls = "com.megacrit.cardcrawl.rooms.AbstractRoom", method = "addGoldToRewards", paramtypez = {int.class})
     ...
     */
    @SpirePatch(cls = "com.megacrit.cardcrawl.rooms.AbstractRoom", method = "addPotionToRewards", paramtypez = {AbstractPotion.class})
    public static class SkipPotionRewards {
        @SpirePrefixPatch
        public static SpireReturn<Void> Prefix(AbstractRoom __instance, AbstractPotion potion) {
            if (ArenaRunner.isArenaRun()) {
